                ...
                <Card className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 dark:text-gray-400">Savannes, prairies, et forêts d'Afrique</p>
                    </div>
                    <div>
                      <h4 className="text-lg font-semibold">État de Santé</h4>
                      <p className="text-gray-500 dark:text-gray-400">Vulnérable</p>
                    </div>
                  </div>
                </Card>
              </CarouselItem>
              <CarouselItem>
                <Card className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold">Habitat</h4>
                      <p className="text-gray-500 dark:text-gray-400">Banquise et zones côtières de l'Arctique</p>
                    </div>
                    <div>
                      <h4 className="text-lg font-semibold">État de Santé</h4>
                      <p className="text-gray-500 dark:text-gray-400">Vulnérable</p>
              ...
              <CarouselItem>
                <Card className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold">Habitat</h4>
                      <p className="text-gray-500 dark:text-gray-400">Forêts de bambous du centre de la Chine</p>
                    </div>
                    <div>
                      <h4 className="text-lg font-semibold">État de Santé</h4>
                      <p className="text-gray-500 dark:text-gray-400">Vulnérable</p>
